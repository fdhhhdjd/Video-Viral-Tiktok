...
import CatLogo from "../../assets/icons/logo/TaiHeoDev.png";
    ...
    <Box widht={"100%"} sx={{ py: 4 }}>
      ...
      >
        <Box>
          ...
          >
            A robust web-based Real-Time Chat App developed by TaiHeoDev.
          </Typography>
      ...
      <Box mt={10}>
        <Stack spacing={2}>
          ...
          <Typography variant="body1">
            TaiHeoDev is a real-time web-based chat application developed by
            TaiHeoDev. Boasting not only a visually appealing UI but also
            packed with an array of enticing features, TaiHeoDev is designed
            ...
            system, TaiHeoDev ensures not just connectivity but a symphony of
