export default (name, reset) => {
  ...
  <html lang="en">
    ...
    <body>
      <div class="container">
        <div class="header">Welcome to TaiHeoDev</div>
        <div class="logo">
          <a href="https://TaiHeoDev.netlify.app/">
            <img src="https://i.imgur.com/KZkoFRO.png" alt="TaiHeoDev Logo" />
          </a>
        </div>
      ...
      <div class="footer">
        ...
        <p>
          ...
          <a href="mailto:TaiHeoDev@gmail.com">TaiHeoDev@gmail.com</a>.
        </p>
      </div>
    </body>
  </html>
